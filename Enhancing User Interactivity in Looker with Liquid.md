## Enhancing User Interactivity in Looker with Liquid [SOLUTION]

Copy this following script to replace ```order_items.view```
```
view: order_items {
...
Copy this following script to replace ```products.view```
```
view: products {
...
Copy this following script to replace ```users.view```
```
view: users {
...
Copy this following script to replace ```training_ecommerce.model```
```
